...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_node_fetch__ = __webpack_require__(5);
 // works after webpack - requires --experimental-modules & .mjs in order to work in node
// const fetch = require('node-fetch'); // broken after webpack - works in node

console.log(__WEBPACK_IMPORTED_MODULE_0_node_fetch__["a" /* default */]);

Object(__WEBPACK_IMPORTED_MODULE_0_node_fetch__["a" /* default */])('https://google.com/')
	.then(res => res.text())
